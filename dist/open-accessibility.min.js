...
var openAccessibility = function openAccessibility(customOptions) {
    ...
    function apply() {
        ...
        if (!first_run || options.contrast != 100) filters.push('contrast(' + options.contrast + '%)');
        if (!first_run || options.brightness != 100) filters.push('brightness(' + options.brightness + '%)');
        if (!first_run || options.grayscale != 0) filters.push('grayscale(' + options.grayscale + '%)');

...
// -------------------------------------------------
var openAccessibility = function openAccessibility(customOptions) {
    var element = this;
    ...
    // -------------
    // Hide expend Button
    document.querySelector(".open-accessibility-expand-button > .hide-expand-button").addEventListener('click', function () {
    ...
    highlightedLinksButton.addEventListener('click', function () {
        options.highlightedLinks = !options.highlightedLinks;
        apply();
    });

    highlightedHeadersButton.addEventListener('click', function () {
    ...
    function apply() {
        ...
        if (options.contrast != defaultOptions.contrast) filters.push('contrast(' + options.contrast + '%)');

        if (options.brightness != defaultOptions.brightness) filters.push('brightness(' + options.brightness + '%)');
        if (options.grayscale != defaultOptions.grayscale) filters.push('grayscale(' + options.grayscale + '%)');
